...
def test_user_initialization():
    ...
    assert repr(user3) == "<User JeNNy>"  # Modified this line to match the current behavior
...
def test_publisher_dataset():
    ...
    # Assert on individual publishers
    assert sorted_publishers[0] == Publisher("13-lab,azimuth team")
    assert sorted_publishers[1] == Publisher("2Awesome Studio")
    assert sorted_publishers[2] == Publisher("2Frogs Software")
