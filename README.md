...
The *project directory/.env* file contains variable settings. They are set with appropriate values. To Switch from 'database' to 'memory' change the Repository variable in the .env file.
